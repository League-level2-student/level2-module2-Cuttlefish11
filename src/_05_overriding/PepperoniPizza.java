...
public class PepperoniPizza extends Pizza {
	...
	// 1. Copy the show() method from Pizza, but change it so it shows a Pepperoni
	// Pizza
	@Override
	public void show() {
	...
	// This helps with preventing errors(you can ask your teacher for further
	// explanation)
	@Override
	public void receipt() {
	...
	// 3. Copy the receipt() method from Pizza, but change it so a Pepperoni Pizza
	// is $12
